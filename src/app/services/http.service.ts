...
export class HttpService {
  ...
  autocompleteIndex(index: string) {
    return this.http.get<{result:any}>(`https://api.postcodes.io/postcodes/${index}/autocomplete`);
  }

  getIndexInfo(index: string) {
    return this.http.get<{result:any}>(`https://api.postcodes.io/postcodes/${index}`);
  }
